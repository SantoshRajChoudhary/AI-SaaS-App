...
function ReviewResume() {
  ...
  return (
    <>
      {/* ✅ SEO METADATA */}
      <Helmet>
        <title>AI Resume Review Tool | OneSolution.ai</title>
        <meta
          name="description"
          content="Analyze your resume with our AI Resume Review tool. Get instant feedback, ATS optimization tips, and improve your chances of landing interviews."
        />
      </Helmet>
      ...
      <div className="h-full overflow-y-scroll p-6 flex flex-wrap gap-5 items-start text-slate-700 transition-all duration-500 ease-in-out">
        ...
        >
          ...
          <button
            className="mt-6 flex gap-3 w-full bg-gradient-to-r from-[#00da83] to-[#009bb3] rounded-lg p-2 justify-center items-center text-white cursor-pointer text-sm"
          >
            {loading ? (
