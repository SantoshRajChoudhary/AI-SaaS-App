          ...
          <div className='mt-2 text-xs flex flex-wrap gap-3'>
            {
              blogCategories.map((item, index)=>(
                ...
                key={index} 
                className={`text-xs border rounded-full md:px-7 md:py-2 px-4 py-2 cursor-pointer ${selectedCategory === item? 'bg-purple-50 text-purple-700 border-purple-300' : 'text-gray-500 border-gray-300'}`}>
                  {item}</span>
              ))
            }
          </div>
