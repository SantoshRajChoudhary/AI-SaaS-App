...
function RemoveObject() {
  ...
  return (
    <>
      {/* ✅ SEO METADATA */}
      <Helmet>
        <title>AI Object Removal Tool | OneSolution.ai</title>
        <meta
          name="description"
          content="Remove unwanted objects from images using our AI Object Removal tool. Upload a photo, select an object, and download the clean image instantly."
        />
      </Helmet>
        ...
        <div className="w-full max-w-xl border border-gray-200 rounded-lg bg-white p-5 min-h-96 max-h-[600px] flex flex-col">
          ...
          {!content ? (
            ...
            <div className="relative mt-3 h-full">
              ...
              <img
                src={content}
                alt="AI object removal processed image"
